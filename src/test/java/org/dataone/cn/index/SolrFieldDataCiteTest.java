...
public class SolrFieldDataCiteTest extends BaseSolrFieldXPathTest {
    ...
    public void setUp() throws Exception {
        ...
        datacite1Expected.put("fileID", "https://" + hostname + "/cn/v1/resolve/" + pid1);
        datacite1Expected
                .put("text",
        ...
        datacite1Expected.put("formatId", "http://schema.datacite.org/meta/kernel-3/metadata.xsd");
        ...
        datacite1Expected.put("dataUrl", "https://" + hostname + "/cn/v1/resolve/" + pid1);
    }
