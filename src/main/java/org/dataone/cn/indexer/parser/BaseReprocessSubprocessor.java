...
public class BaseReprocessSubprocessor implements IDocumentSubprocessor {
    ...
    public Map<String, SolrDoc> processDocument(String identifier, Map<String, SolrDoc> docs,
        ...
        perfLog.info(String.format("%s, %d", "BaseReprocessSubprocessor.processDocument() HazelcastClientFactory.getSystemMetadataMap().get(id)", (System.currentTimeMillis() - getSysMetaStart)));
        ...
        if (seriesId != null) {
            ...
            perfLog.info(String.format("%s, %d", "BaseReprocessSubprocessor.processDocument() HttpService.getDocumentsByField(idsInSeries)", (System.currentTimeMillis() - getIdsInSeriesStart)));
            ...
            perfLog.info(String.format("%s, %d", "BaseReprocessSubprocessor.processDocument() reprocessing all docs earlier in sid chain", System.currentTimeMillis() - getIdsInSeriesStart));
        }
        return docs;
    }
